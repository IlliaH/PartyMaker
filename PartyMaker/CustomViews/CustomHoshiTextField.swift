...
//  PartyMaker
//
//  Created by  Ilia Goncharenko on 2019-10-19.
...
@IBDesignable open class CustomHoshiTextField: TextFieldEffects {
    ...
    */
    ...
    private let placeholderInsets = CGPoint(x: 0, y: 18)
    private let textFieldInsets = CGPoint(x: 0, y: 24)
    private let inactiveBorderLayer = CALayer()
    private let activeBorderLayer = CALayer()
    private var activePlaceholderPoint: CGPoint = CGPoint.zero
    // padding
    let padding = UIEdgeInsets(top: 2, left: 0, bottom: 0, right: 0)
    ...
    private func layoutPlaceholderInTextRect() {
        ...
        placeholderLabel.frame = CGRect(x: originX, y: textRect.height/3,
                                        width: textRect.size.width, height: placeholderLabel.bounds.height)
